...
Proxymity.prototype.update = function update() {
  var self = this;
  try {
...
Proxymity.prototype.stop = function stop() {
  if ( this.state === 'idle' ) return;
  this.interval = clearInterval(this.interval);
  this.state = 'idle';
}

Proxymity.prototype.start = function start() {
  var self = this;
...
module.exports = Proxymity;


if (module.parent === null) {
  var sensor = new Proxymity();
